        ...
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Community
                                Services</span></a></li>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>About</h2>
                    <p>My name is Muhammad Akbar Rahman, Currently i'm a student in BINUS University and my passion are
                        at web and android development.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>28 December
                                            2003</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Portofolio Link:</strong>
                                        <span>https://youtu.be/JX7QGK9x00g</span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62
                                            895396711262</span></li>
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Pursuing
                                            Bachelor</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                        <span>akbarahman28@gmail.com</span>
                                    </li>
